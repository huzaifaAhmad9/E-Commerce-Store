...
public class Frap_Pumpkin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frap_pumpkin);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("FrappuccinoPumpkin").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("FrappuccinoPumpkin").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.fra4;  // Set your image resource here
