...
public class Am_Almond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_am_almond);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("AmericanoAlmond").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("AmericanoAlmond").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.am1;  // Set your image resource here
