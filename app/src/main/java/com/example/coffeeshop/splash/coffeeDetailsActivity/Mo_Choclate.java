...
public class Mo_Choclate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_choclate);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("MochaChoclate").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("MochaChoclate").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.moc5;  // Set your image resource here
