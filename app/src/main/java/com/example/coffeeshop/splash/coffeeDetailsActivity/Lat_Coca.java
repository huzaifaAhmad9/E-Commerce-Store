...
public class Lat_Coca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lat_coca);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("LatCoca").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("LatCoca").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.lat3;  // Set your image resource here
