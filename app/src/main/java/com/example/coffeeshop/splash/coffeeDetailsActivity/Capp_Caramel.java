...
public class Capp_Caramel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capp_caramel);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("CappuccinoCaramel").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("CappuccinoCaramel").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.img2;  // Set your image resource here
