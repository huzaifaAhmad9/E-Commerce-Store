...
public class Lat_Vanilla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lat_vanilla);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("LatVanilla").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("LatVanilla").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.lat2;  // Set your image resource here
