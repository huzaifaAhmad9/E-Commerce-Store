...
public class Capp_Vanilla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capp_vanilla);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("CappuccinoVanilla").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("CappuccinoVanilla").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.img7;  // Set your image resource here
