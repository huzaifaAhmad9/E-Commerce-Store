...
public class Capp_Cinnamon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capp_cinnamon);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("CappuccinoCinnamon").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("CappuccinoCinnamon").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.img3;  // Set your image resource here
