...
public class Capp_Milk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capp_milk);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("CappuccinoMilk").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("CappuccinoMilk").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.img4;  // Set your image resource here
