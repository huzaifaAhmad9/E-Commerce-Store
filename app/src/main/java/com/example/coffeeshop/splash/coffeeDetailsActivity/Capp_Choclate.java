...
public class Capp_Choclate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capp_choclate);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("CappuccinoChocolate").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("CappuccinoChocolate").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.cap2;  // Set your image resource here
