...
public class Mo_Expresso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_expresso);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("MochaExpresso").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("MochaExpresso").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.moc1;  // Set your image resource here
