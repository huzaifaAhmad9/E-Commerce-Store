...
public class Frap_Caramel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frap_caramel);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("FrappuccinoCaramel").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("FrappuccinoCaramel").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.fra2;  // Set your image resource here
