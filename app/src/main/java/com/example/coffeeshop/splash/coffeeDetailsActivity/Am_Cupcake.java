...
public class Am_Cupcake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_am_cupcake);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("AmericanoCupcake").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("AmericanoCupcake").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.am3;  // Set your image resource here
