...
public class Am_Caramel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_am_caramel);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("AmericanoCaramel").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("AmericanoCaramel").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.am2;  // Set your image resource here
