...
public class Frap_ButterBear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frap_butter_bear);
    ...
    private void updateFavoriteState() {
        favoritesReference.child("FrappuccinoButterBear").setValue(isFavorite);
    }

    private void fetchFavoriteState() {
        favoritesReference.child("FrappuccinoButterBear").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void addToCart() {
        ...
        int imageResource = R.drawable.fra3;  // Set your image resource here
